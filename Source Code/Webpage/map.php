      ...
      <div id="mapSideBar">
        <div>
          <p class='alignRight'>Date between:
            ...
            <select id='day1Selector' name='daySelector' onchange="changeFlagToLoadNewMarkers()">
            </select>
			
			<select id='year1Selector' name='yearSelector' onchange="changeFlagToLoadNewMarkers()">
			</select>
          </p>
          <p class='alignRight'>
              and
            ...
            <select id='day2Selector' name='daySelector' onchange="changeFlagToLoadNewMarkers()">
            </select>
			
			<select id='year2Selector' name='yearSelector' onchange="changeFlagToLoadNewMarkers()">
			</select>
          </p>
        </div>
        <br/>
