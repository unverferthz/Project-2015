...
public class ViewIncidents extends Activity {
    ...
    public void init(){
        ...
        spinYear = (Spinner)findViewById(R.id.spinIncidentYear);
        ...
        spinDay.setOnItemSelectedListener(new spinHandlerUpdateList());
        spinMonth.setOnItemSelectedListener(new monthSelected());
        spinYear.setOnItemSelectedListener(new spinHandlerUpdateList());
    ...
    private class spinHandlerUpdateList implements OnItemSelectedListener {
        @Override
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
           populateList();
        }
